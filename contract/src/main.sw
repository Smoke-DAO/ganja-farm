...
const INITIAL_COINS: u64 = 0;
const MAX_SKILL_LEVEL: u8 = 10;
const EXP_MULTIPLIER: u64 = 3_000_000;
const TOMATO_SEED_PRICE: u64 = 750_000;
const TOMATO_SELL_PRICE: u64 = 7_500_000;
const HARVEST_TIME_DELAY: u64 = 120 * 5; // 5 minutes
...
impl GameContract for Contract {
    ...
    fn new_player() {
        ...
        mint_to(sender, DEFAULT_SUB_ID, INITIAL_COINS);
    ...
    fn level_up() {
        ...
        require(player.farming_skill < MAX_SKILL_LEVEL, "skill already max");

        let new_level = player.farming_skill + 1;

        // require that the total_value_sold > their new level squared * EXP_MULTIPLIER
        let exp = new_level * new_level * EXP_MULTIPLIER;
    ...
    fn buy_seeds(food_type: FoodType, amount: u64) {
        ...
        let mut price = match food_type {
            FoodType::Tomatoes => TOMATO_SEED_PRICE,
    ...
    fn harvest(indexes: Vec<u64>) {
        ...
        while count < indexes.len() {
            ...
            let finish_time = planted_time + HARVEST_TIME_DELAY;
    ...
    fn sell_item(food_type: FoodType, amount: u64) {
        ...
        let mut amount_to_mint = match food_type {
            FoodType::Tomatoes => TOMATO_SELL_PRICE * amount,
            // the compiler knows that other options would be unreachable
        };
    ...
    fn can_level_up(id: Identity) -> bool {
        ...
        // the max skill level is 10
        if player.farming_skill < MAX_SKILL_LEVEL {
            let new_level = player.farming_skill + 1;
            let exp = new_level * new_level * EXP_MULTIPLIER;
